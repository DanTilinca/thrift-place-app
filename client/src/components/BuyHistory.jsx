      ...
      {products.length === 0 ? (
        ...
        <div className="space-y-6">
          {products.map((product) => (
            <div key={product._id} className="flex items-center bg-white p-6 rounded-lg shadow-lg">
              {/* Product Image */}
              <img src={product.images[0]} alt={product.title} className="w-32 h-32 object-cover rounded-md border" />
              {/* Product Details */}
              <div className="ml-6">
